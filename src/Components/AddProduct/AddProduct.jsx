...
const AddProduct = (props) => {
    ...
    const validateAndSave = () => {
        const detectedErrors = {
            [PRODUCT_NAME_ERROR]: itemName.length === 0 ? PRODUCT_NAME_ERROR_TEXT : null,
            [PRODUCT_DESC_ERROR]: itemDescription.length === 0 ? PRODUCT_DESC_ERROR_TEXT : null
        };
    ...
    return ( isOpen &&
        ...
        >
            <DialogTitle className="AddItemTitle">
                SHOPPING LIST
            </DialogTitle>
